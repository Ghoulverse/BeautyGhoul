    ...
    if (newExpr === 1) {
      ...
      for (let i = 0; i < 20; i++) {
        dripsRef.current.push({
          ...
          opacity: 1,
          color: Math.random() > 0.5 ? '#ec4899' : '#b76e79',
          life: 0,
        });
      }
      setTimeout(() => {
    ...
    const animate = () => {
      ...
      if (isMoving && velocity > 2) {
        posHistoryRef.current.forEach((pos, i) => {
          ...
          dripCtx.fillStyle = `rgba(236, 72, 153, ${opacity})`;
          dripCtx.fill();
          dripCtx.beginPath();
          dripCtx.arc(pos.x + ghostSize / 2, pos.y + ghostSize / 2, size * 0.5, 0, Math.PI * 2);
          dripCtx.fillStyle = `rgba(183, 110, 121, ${opacity * 0.6})`;
          dripCtx.fill();
        });
      }
      ...
      miniGhostsRef.current = miniGhostsRef.current.filter((mg) => {
        ...
        dripCtx.fillStyle = '#b76e79';
        dripCtx.fill();
        dripCtx.fillStyle = '#ec4899';
        dripCtx.beginPath();
  ...
  return (
    <>
      ...
      >
        {speechBubble && (
          <div
            className="absolute -top-14 left-1/2 -translate-x-1/2 px-4 py-2 rounded-xl whitespace-nowrap font-playfair text-lg pointer-events-none"
            style={{
              background: 'rgba(250, 245, 240, 0.9)',
              border: '1px solid rgba(236, 72, 153, 0.3)',
              color: expression === 2 ? '#ef4444' : '#ec4899',
        ...
        <div
          ...
          style={{
            ...
            height: ghostSize,
            filter: isHovered
              ? 'drop-shadow(0 0 25px #ec4899) drop-shadow(0 0 50px #b76e79) brightness(1.2)'
              : undefined,
          ...
          >
            <div
              ...
              style={{
                ...
                boxShadow: '0 0 6px #ec4899, 0 0 12px #ec4899',
