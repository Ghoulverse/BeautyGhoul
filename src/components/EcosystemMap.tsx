      ...
      <div className="max-w-6xl mx-auto">
            ...
            return (
              <a
                ...
                className={`group relative rounded-xl p-4 text-center transition-all duration-300 hover:-translate-y-1 ${
                  isCurrent
                    ? 'border-2 border-[#ec4899] bg-[#ec4899]/10'
                    : 'border border-white/10 bg-white/5 hover:border-white/20'
                }`}
              >
                {isCurrent && (
                  <span className="absolute -top-2 left-1/2 -translate-x-1/2 text-[9px] font-bold tracking-wider uppercase px-2 py-0.5 rounded-full bg-[#ec4899] text-white">
                    You Are Here
                  </span>
                )}
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-10">
          {[
            ...
            <div key={stat.label} className="glass rounded-xl p-5 text-center">
              <p className="font-mono text-3xl md:text-4xl text-[#ec4899] mb-1">{stat.value}</p>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
          <a
            ...
            style={{ background: 'linear-gradient(135deg, #ec4899, #00f0ff)' }}
          >
