...
export const config: GhoulConfig = {
  ...
  products: [
    { name: "Makeup Brush Purifier", comingSoon: true },
    { name: "Cosmetic Sanitizer", comingSoon: true },
    { name: "Witch Hazel Toner", comingSoon: true },
    { name: "Vanity Surface Polish", comingSoon: true },
    { name: "Beauty Organizer Spray", comingSoon: true },
  ],
  ...
  cta: {
    ...
    subheadline: "Join the glamour circle. Be the first to know when we drop.",
    buttonText: "Unlock the Glamour",
